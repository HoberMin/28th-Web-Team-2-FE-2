...
//    → `button.tsx`를 고치지 않고 **가장 가까운 기존 variant**(tertiary · medium)로 렌더한다.
//      차이: radius 12px(rounded-lg) vs Figma 8px, 높이 48.8px vs Figma 44px 고정.
//      임의로 h-11이나 rounded-md를 덧씌우면 컴포넌트 규격을 화면에서 갈라놓는 셈이라 하지 않았다.
