...
// 등록된 컴포넌트가 아니다 — `search_design_system`에 결과가 없고, 6행이 서로 다른 로컬
// 마스터를 쓰고 있다. design-guide §1-1("Figma에 있는 규격만 등록")에 따라 정식 공통
// 컴포넌트로 올리지 않고 화면 로컬로 둔다. **`/playground` 스토리도 만들지 않는다.**
//
...
//
// ⚠️ 썸네일 사진과 하트 아이콘은 슬롯이다 — Figma 에셋을 코드로 가져올 수 없다(figma-bridge §0-0).
//
