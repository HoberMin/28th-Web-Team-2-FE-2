...
export function LocationLabel() {
  ...
  return (
    <BottomSheetRoot open={open} onOpenChange={(nextOpen) => handleOpenChange(nextOpen)}>
      ...
      >
        <span className="text-orange-700 [&_svg]:size-6" aria-hidden="true">
          <IconLocationpinFill />
        </span>
        <span className="text-body-16-bold">{loading ? "위치 확인 중…" : district}</span>
          ...
          {view === "list" ? (
                  ...
                  return (
                    <li key={name}>
                      <button
                        ...
                        className="flex h-12 w-full items-center justify-between text-left active:bg-gray-100"
                      >
                        <span
                          className={
                            active
                        ...
                        {active && (
                          <span className="text-caption-12-regular text-orange-700">현재 동네</span>
                        )}
                      </button>
                    </li>
                  );
            ...
            <>
              ...
              <button
                ...
                className="flex h-11 items-center gap-1 self-start text-body-14-medium text-content-secondary active:text-content-primary"
              >
