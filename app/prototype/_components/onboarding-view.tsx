      ...
      <PhoneFrame>
        ...
        >
          <Scroll className="px-4 pt-10">
            <h1 className="text-title-24-medium text-content-primary">사용할 닉네임을 알려주세요</h1>
            <div className="mt-8">
              <TextField
                value={nickname}
      ...
      <div onPointerDown={handleBackgroundPointerDown} className="flex min-h-0 flex-1 flex-col">
        ...
        <header className="relative flex h-14 shrink-0 items-center px-2">
          <button
            ...
            className="flex size-12 items-center justify-center rounded-full text-content-primary active:bg-gray-100 [&_svg]:size-6"
          >
            <IconChevronLeftLine />
          </button>
        </header>
        <Scroll className="px-4 pt-2">
          <h1 className="text-title-24-medium text-content-primary">평소 어디에서 야채를 구매하나요?</h1>
          <div className="mt-8">
