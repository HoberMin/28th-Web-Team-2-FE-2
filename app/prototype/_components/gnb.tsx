...
export function GNB() {
  ...
  return (
    <nav
      aria-label="주요 메뉴"
      className="flex h-16 shrink-0 items-stretch border-t border-border-secondary bg-surface-primary"
    >
      {TABS.map((tab) => {
        ...
        return (
          ...
          >
            ...
            <span
              className={`[&_svg]:size-6 ${active ? "text-orange-700" : "text-content-secondary"}`}
              aria-hidden="true"
            >
              <Icon />
            </span>
