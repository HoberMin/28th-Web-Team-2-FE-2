...
export function CalloutLink({ href, children }: { href: string; children: ReactNode }) {
  return (
    <Link
      href={href}
      className="flex min-h-11 items-center justify-center rounded-xl bg-gray-100 px-4 py-3 text-center text-body-14-medium text-content-primary active:bg-gray-200"
    >
      {children}
    </Link>
  );
