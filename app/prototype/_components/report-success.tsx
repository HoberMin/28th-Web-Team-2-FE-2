...
// 왜 필요한가: 가게 축 화면(가게 탭·가게 상세)이 성립하려면 "한 가게 × 여러 품목" 제보가 있어야 한다.
  ...
  return (
    <PhoneFrame>
      <Scroll className="flex flex-col items-center justify-center gap-4 px-6 py-10 text-center">
        ...
        <p className="text-title-24-medium text-content-primary">제보 성공!</p>
        {place && (
          <p className="text-body-14-regular text-content-secondary">
            <strong className="font-semibold text-content-primary">{place}</strong>에서 본 다른 가격도
            <br />
        ...
        {place && (
          <div className="mt-4 flex w-full flex-col gap-3 rounded-2xl bg-gray-100 p-4 text-left">
            <p className="text-body-14-medium text-content-primary">
              <strong className="font-semibold">{place}</strong>, 전반적으로 어땠나요?
              <span className="ml-1 text-caption-12-regular text-content-secondary">(선택)</span>
            </p>
            <RadioChipRoot
              aria-label="가게 신선도"
