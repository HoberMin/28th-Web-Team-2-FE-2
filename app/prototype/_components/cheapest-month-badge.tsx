...
export function CheapestMonthBadge({ yearSeries }: { yearSeries: PricePoint[] }) {
  ...
  return (
    <p className="rounded-xl bg-orange-50 px-4 py-3 text-body-14-regular text-content-primary">
      <span className="font-semibold text-content-primary">{cheapest.month}월</span>이 최근 1년 중 가장 쌌어요 (지금보다
