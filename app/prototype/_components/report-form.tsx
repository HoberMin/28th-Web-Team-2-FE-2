      ...
      <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
        <Scroll className="px-4 pb-6">
          <div className="flex items-start justify-between gap-3">
            <h1 className="text-title-20-bold leading-snug text-content-primary">
              야채의 실제 가격을
              <br />
              알려주세요
            </h1>
          ...
          <div className="mt-6 flex flex-col gap-2">
            <p className="text-body-14-medium text-content-primary">
              사진 <span className="text-content-secondary">(선택)</span>
            </p>
            <input
              ref={fileInputRef}
              type="file"
            ...
            {photoUrl ? (
              ...
              <label
                ...
                className="flex h-28 w-28 flex-col items-center justify-center gap-1 rounded-2xl border border-dashed border-border-primary text-content-secondary active:bg-gray-100"
              >
          ...
          <div className="mt-6 flex flex-col gap-6">
            ...
            <TextField label="가격" value={price} onValueChange={(v) => setPrice(v.value)} suffix="원">
              <TextFieldInput placeholder="0" inputMode="numeric" className="text-title-24-medium font-semibold" />
            </TextField>
          </div>
        </Scroll>
