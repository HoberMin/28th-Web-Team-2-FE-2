...
export function CommentList({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {readError ? (
        <p className="rounded-xl bg-gray-100 px-4 py-8 text-center text-body-14-regular text-content-secondary">
        ...
        <ul className="flex flex-col gap-3">
          {entries.map((e) => (
            <li key={e.id} className="rounded-2xl bg-gray-100 px-4 py-3">
              <div className="flex items-baseline justify-between gap-2">
                <span className="flex items-center gap-1.5 text-body-14-medium text-content-primary">
                  {e.authorLabel}
                  {e.ratingLabel && (
                    <span className="rounded bg-surface-primary px-1.5 py-0.5 text-caption-12-regular text-content-secondary">
                      {e.ratingLabel}
                    </span>
                  )}
                </span>
              ...
              <p className="mt-1 text-body-14-regular text-content-primary">{e.body}</p>
            </li>
          ))}
        </ul>
      )}
      ...
      {canWrite ? (
        ...
        <p className="rounded-xl bg-gray-100 px-4 py-3 text-center text-caption-12-regular text-content-secondary">
