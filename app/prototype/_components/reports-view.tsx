            ...
            >
              <span className="flex min-w-0 flex-1 flex-col">
                <span className="flex items-center gap-1.5">
                  <span className="text-body-16-semibold text-content-primary">
              ...
              <span className="flex flex-col items-end gap-0.5">
                <span className="text-body-14-medium text-content-primary">
                  {formatNumber(r.pricePerKg)}원 <span className="text-content-secondary">/1kg</span>
                </span>
                {diff !== 0 && (
                  <span
              ...
              {editable && (
                <button
                  ...
                  className="flex size-9 shrink-0 items-center justify-center rounded-full text-content-secondary active:bg-gray-200 [&_svg]:size-5"
                >
          ...
          <BottomSheetContent title="제보 관리" showHandle>
            <BottomSheetBody className="flex flex-col gap-1 pb-4">
              <button
                ...
                className="flex h-12 w-full items-center gap-3 rounded-xl px-2 text-left text-body-16-regular text-content-primary active:bg-gray-100"
              >
                <IconPencilLine className="size-5 text-content-secondary" aria-hidden="true" />
                수정
              </button>
              <button
                type="button"
                onClick={() => setSheet({ report: sheet.report, mode: "delete" })}
                className="flex h-12 w-full items-center gap-3 rounded-xl px-2 text-left text-body-16-regular text-red-600 active:bg-gray-100"
              >
