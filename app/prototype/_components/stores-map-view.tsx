  ...
  return (
    <div className="relative flex min-h-0 flex-1 flex-col">
      ...
      <div className="relative min-h-0 flex-1 overflow-hidden bg-gray-100">
        <p
          aria-hidden="true"
          className="pointer-events-none absolute inset-0 flex items-center justify-center text-title-24-medium text-content-secondary"
        >
          지도
        </p>
        ...
        {shown.map((store) => {
          ...
          return (
            <button
              ...
              className="absolute flex max-w-32 -translate-x-1/2 -translate-y-full items-center gap-1 rounded-full border border-border-secondary bg-surface-primary px-2.5 py-1.5 text-caption-12-medium text-content-primary shadow-md"
            >
      ...
      <button
        ...
        className={`absolute bottom-4 right-4 flex size-12 items-center justify-center rounded-full shadow-lg [&_svg]:size-6 ${
          favoritesOnly
            ? "bg-orange-600 text-content-inverse"
