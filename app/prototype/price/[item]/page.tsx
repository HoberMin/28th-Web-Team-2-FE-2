        ...
        <div className="flex flex-col pb-6">
          ...
          <div className="flex gap-4 px-4 pt-1 pb-6">
            ...
            <div className="flex min-w-0 flex-1 flex-col justify-center">
              <h1 className="text-title-20-medium text-content-primary">
                {veg.name} <span className="text-content-secondary">{veg.unit}</span>
              </h1>
              <div className="mt-3 flex flex-col gap-2">
                <div className="flex items-end justify-between gap-2">
                  <span className="text-body-16-semibold text-content-primary">동네 제보가</span>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-caption-12-regular text-content-secondary">오늘 시세</span>
                  <span className="text-body-14-medium tabular-nums text-content-secondary">
                    {formatWon(baseline.current)}
                  </span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-caption-12-regular text-content-secondary">어제 대비</span>
          ...
          {/* 섹션 구분 band */}
          <div className="h-1.5 shrink-0 bg-gray-100" aria-hidden="true" />

          {/* 동네 제보가 — 그래프보다 위이고 제목도 한 급 위다. 이 서비스의 차별점이자
              "지금 살까"의 직접 근거다. */}
          <section className="flex flex-col gap-4 px-4 pt-6" aria-label="동네 제보가">
            <div className="flex items-center justify-between">
              <h2 className="text-title-20-bold text-content-primary">동네 제보가</h2>
              <DistrictBadge />
            </div>
            <ReportsList
              vegetableId={veg.id}
          ...
          {/* 섹션 구분 band */}
          <div className="mt-6 h-1.5 shrink-0 bg-gray-100" aria-hidden="true" />
