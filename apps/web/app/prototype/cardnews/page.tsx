                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="flex min-w-0 flex-col">
                      <span className="text-body-16-semibold text-fg-neutral">{item.title}</span>
                      <span
                  ...
                  <p className="text-body-14-regular text-fg-neutral-muted">{item.body}</p>
                  {/* 읽고 나서 할 행동 — 카드가 "사기 좋은 시기"라 말해놓고 목적지가 없던 문제
                      (백로그 F08). 실제 이동지는 해당 품목 시세 화면이라 그렇게 읽히게 한다. */}
                  <span className="flex items-center gap-0.5 text-caption-12-regular text-fg-brand-contrast">
                    {veg.name} 시세 보러 가기
