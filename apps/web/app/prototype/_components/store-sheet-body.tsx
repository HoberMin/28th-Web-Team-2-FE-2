  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-1">
        <p className="text-body-14-regular tabular-nums text-fg-neutral-muted">
        ...
        <p className="text-body-14-regular text-fg-neutral">
          {store.avgDiffPct === null ? (
            <span className="text-fg-neutral-muted">아직 시세와 비교할 제보가 부족해요</span>
          ) : store.avgDiffPct < 0 ? (
            <>
              시세보다 평균{" "}
              <span className="tabular-nums text-fg-positive">
            ...
            <>
              시세보다 평균{" "}
              <span className="tabular-nums text-fg-neutral-muted">{store.avgDiffPct}% 비쌈</span>
            </>
          )}
        </p>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={`flex size-11 shrink-0 items-center justify-center rounded-xl border border-bg-neutral-weak-pressed active:bg-bg-neutral-weak [&_svg]:size-5 ${
            isFavorite ? "text-fg-critical" : "text-fg-neutral-muted"
          }`}
        >
