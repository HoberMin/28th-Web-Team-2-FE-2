  ...
  return (
    ...
    >
      <span className="flex min-w-0 flex-col">
        <span className="text-caption-12-regular text-fg-brand">예시 · 이번 주 시세 이야기</span>
        <span className="truncate text-body-14-medium text-fg-neutral">
          {veg?.emoji} {top.title}
        </span>
      </span>
      <span aria-hidden="true" className="shrink-0 text-body-14-medium text-fg-neutral-subtle">
        더보기
      </span>
    </Link>
  );
